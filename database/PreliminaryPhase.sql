/*
 ...
 -- These PCMembers create their accounts so they initially will have the default use type "Listener"
 -- The SCMember that created the conference or either SCMembers will need to switch the
 -- account type of the PCMembers from default "Listener" to PCMember / Chair / Co-chair
